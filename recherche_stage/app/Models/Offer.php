...
class Offer {
    ...
    // Recherche les offres en classant en premier celles dont le titre ou la description correspondent au terme recherché.
    ...
    // Récupère toutes les offres (sans jointure) - si besoin.
    ...
    // Recherche les offres par critères (multi-critères).
    ...
    // Récupère les offres avec une limite et un offset (pour la pagination)
    public function getOffersWithLimit($limit, $offset) {
        $sql = "SELECT o.offer_id, o.title, o.company_id, o.description, o.competencies, o.remuneration_base, o.start_date, o.end_date, c.name AS company_name 
                FROM offers o
                INNER JOIN companies c ON o.company_id = c.company_id
                LIMIT ? OFFSET ?";
        $stmt = $this->db->prepare($sql);
    ...
    // Obtient le nombre total d'offres.
