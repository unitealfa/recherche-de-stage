...
<div class="dashboard-container">
  <h1>Bienvenue sur votre tableau de bord Pilote, <?= htmlspecialchars($_SESSION['user']['first_name']); ?> !</h1>
  ...
  <div class="actions-container">
    ...
    <a href="index.php?controller=user&action=index" class="action-btn" style="text-decoration: none;">Gérer les comptes étudiants</a>
