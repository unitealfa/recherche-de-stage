...
<div class="dashboard-container">
  <h1>Bienvenue sur votre tableau de bord Étudiant, <?= htmlspecialchars($_SESSION['user']['first_name']); ?> !</h1>
    ...
    <div class="stat-card">
      <div class="icon-container bg-lilac">
        ...
        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#fff" style="width:60%; height:60%;">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M13.507 12.324a7 7 0 0 0 .065-8.56A7 7 0 0 0 2 4.393V2H1v3.5l.5.5H5V5H2.811a6.008 6.008 0 1 1-.135 5.77l-.887.462a7 7 0 0 0 11.718 1.092z"/>
        </svg>
      </div>
  ...
  <!-- Liens d'actions propres à l'étudiant -->
  <div class="actions-container">
    <a href="index.php?controller=offer&action=index" class="action-btn" style="text-decoration: none;">Rechercher des offres de stage</a>
    <a href="index.php?controller=candidature&action=index" class="action-btn" style="text-decoration: none;">Voir mes candidatures</a>
    <a href="index.php?controller=wishlist&action=index" class="action-btn" style="text-decoration: none;">Voir ma wish list</a>
  </div>
</div>
